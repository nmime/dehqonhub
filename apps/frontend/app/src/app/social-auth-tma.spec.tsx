...
describe('social auth and TMA UI', () => {
  ...
  it('starts Telegram OIDC from the social entry instead of routing to TMA', async () => {
    ...
    const telegramButton = screen.getByRole('button', { name: 'auth.social.button.telegram' });
    fireEvent.click(telegramButton);
    fireEvent.click(telegramButton);
    expect(onTelegram).toHaveBeenCalledOnce();
    directButtons.rerender(
      <SocialAuthButtons
        isDiscordPending={false}
        isTelegramEnabled
        isTelegramPending
