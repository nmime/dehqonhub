...
3. **Setting up CODEOWNERS, issue templates, dependency update services, and any external security services** — still manual or scripted outside the engine; this repository does not install GitHub Actions or CodeQL.
